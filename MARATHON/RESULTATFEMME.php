...
try {
    $sql = "SELECT * FROM athlete where SEXE='F' ";
    $res = $conn ->query($sql);
    if ($res->rowCount() > 0) {
      echo "<div class='container' >";
        echo "<table  class='table' style='background-color: rgba(100,100,100,0.6);color:white' >";
        echo "<tr>";
        echo "<th>NOM</th>";
        echo "<th>PRENOM</th>";
        echo "<th>Age</th>";
  ...
  <p align="center"><img src="png-clipart-symbol-information-logo-sign-stop-miscellaneous-text.png" width="100px"><br>les resultats n'est pas encore sortis</p>
  </div>
  <?php
    }
}
